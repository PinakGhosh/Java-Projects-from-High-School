public class RewardsTester {
	public static void main(String[] args){
		...
		Customer customer2 = new Customer("Neville", "Longbottom", "July 30, 1980","","");

		customer2.setFirstName("Neville");
        //call the setDOB(String) method via the dot operator
        customer2.setDateOfBirth("July 30, 1980");

		customer1.printInfo();
    	customer2.printInfo();

    	customer1.addPoints(25);
    	customer2.addPoints(29);
...
class Customer {
	...
	void printInfo(){
		...
		System.out.println("D.O.B: " + strDateOfBirth);
